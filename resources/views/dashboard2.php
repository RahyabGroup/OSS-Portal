	...
	<div onresize="myFunctionx()" onload="myFunctionx()">						
		...
		<div id="AllMobileBadges">	
									...
									<button id="buttonx-left" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
																													...
																													<?php echo Lang::get('language.product_list')?><br><img src="List.png" alt="product" height="30" width="30"><img src="newProductArrow.png" alt="product" height="15" width="15"></button>
									...
									<button id="buttonx-right" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                ...
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.new_product')?><br><img src="newProduct.png" alt="product" height="30" width="30"><img src="newProductArrow.png" alt="product" height="15" width="15"></button>									
								 
								<button id="buttonx-left" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:95%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.product_sta')?><br><img src="statistics.png" alt="product" height="30" width="30"><img src="newProductArrow.png" alt="product" height="15" width="15"></button>
									
									<button id="buttonx-right" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:90%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.product_op')?><br><img src="operation.png" alt="product" height="30" width="30"><img src="newProductArrow.png" alt="product" height="15" width="15"></button>
	 	...
	 	<div class="hiddenn">	    <div id="mobileBadge">	 <span class="badgeGreen-5"><div class="WhiteBadgeNum">3</div></span> <span class="badgeYellow-5"><div class="blackBadgeNum">3</div></span><span class="badgeRed-5"><div class="WhiteBadgeNum">3</div></span><span class="badgeOrange-5"><div class="WhiteBadgeNum">3</div></span> </div>
									...
									<div id="mobileBadge">	 <span class="badgeGreen-6"><div class="WhiteBadgeNum">3</div></span> <span class="badgeYellow-6"><div class="blackBadgeNum">3</div></span><span class="badgeRed-6"><div class="WhiteBadgeNum">3</div></span><span class="badgeOrange-6"><div class="WhiteBadgeNum">3</div></span> </div>	
									...
									<button id="buttonx-midlle" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:98%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
																													...
																													<?php echo Lang::get('language.product_kpi')?><br><img src="kpi.png" alt="product" height="42" width="42"><img src="newProductArrow.png" alt="product" height="15" width="15"></button>
