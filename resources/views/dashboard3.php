...
<div id="on_javascript_rise">
								<button id="buttonx-left" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
																													...
																													<?php echo Lang::get('language.product_list')?><br><img src="customerList.png" alt="product" height="20" width="20">&emsp;<img src="customers.png" alt="product" height="20" width="20"></button>
									...
									<button id="buttonx-right" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                ...
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.new_customer')?><br><img src="newCustomer.png" alt="product" height="30" width="30"></button>									
								
								<button id="buttonx-left" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:95%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.customer_op')?><br><img src="operation.png" alt="product" height="20" width="20">&emsp;<img src="customers.png" alt="product" height="20" width="20"></button>
									
									<button id="buttonx-right" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:90%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.customer_sta')?><br><img src="statistics.png" alt="product" height="20" width="20">&emsp;<img src="customers.png" alt="product" height="20" width="20"></button>
						   	
									<button id="buttonx-left" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:95%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.contacts')?><br><img src="statistics.png" alt="product" height="20" width="20">&emsp;<img src="phone.png" alt="product" height="20" width="20"></button>
									
									<button id="buttonx-right" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:90%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.customer_tkt')?><br><img src="myTickets.png" alt="product" height="30" width="30">&emsp;<img src="customers.png" alt="product" height="20" width="20"></button>
									...
									<button id="buttonx-midlle" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:98%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
																													...
																													<?php echo Lang::get('language.ce_kpi')?><br><img src="kpi.png" alt="product" height="20" width="20">&emsp;<img src="customers.png" alt="product" height="20" width="20"></button>
