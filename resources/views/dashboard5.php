...
<div id="on_javascript_rise">
								 <button id="buttonx-left" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
																													...
																													<?php echo Lang::get('language.net_topology')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="topology.png" alt="product" height="25" width="25"></button>
									 ...
									 <button id="buttonx-right" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                ...
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.ems')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="mng.png" alt="product" height="20" width="20"></button>									
								
								 <button id="buttonx-left" type="button" class="btn btn-info btn-block badge1" style="font-size:17px;" ><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:95%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.performance_mng')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="perfomance.png" alt="product" height="30" width="30"></button>
									
									 <button id="buttonx-right" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:90%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.fault_mng')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="exclamationMark.png" alt="product" height="30" width="30"></button>
						   	
									 <button id="buttonx-left" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:95%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.change_mng')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="arrows.png" alt="product" height="20" width="20"></button>
									
									 <button id="buttonx-right" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:90%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.capacity_mng')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="battery.png" alt="product" height="30" width="30"></button>
									
									 <button id="buttonx-left" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:95%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.network_kpi')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="kpi.png" alt="product" height="25" width="25"></button>
									
									 <button id="buttonx-right" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-5%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:90%; right:90%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													<?php echo Lang::get('language.net_fulfilment')?><br><img src="network.png" alt="product" height="25" width="25">&emsp;<img src="toolsBag.png" alt="product" height="25" width="25"></button>
