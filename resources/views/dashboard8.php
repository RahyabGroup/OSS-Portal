...
<body  onresize="myFunctionx()" onload="myFunctionx()">
<div id="wrapper">
		<!--
		/////////////////////////////////////////////////////////////////////////
		//////////     HEADER  CONTENT     ///////////////
...
<div id="on_javascript_rise">
	...
	<div class="hiddenn">			<div id="mobileBadge">	 <span class="badgeGreen-1"><div class="WhiteBadgeNum">3</div></span> <span class="badgeYellow-1"><div class="blackBadgeNum">3</div></span><span class="badgeRed-1"><div class="WhiteBadgeNum">3</div></span><span class="badgeOrange-1"><div class="WhiteBadgeNum">3</div></span> </div>
									<button id="buttonx-left" type="button" class="btn btn-info btn-block"></button>
								
									<div id="mobileBadge">	 <span class="badgeGreen-2"><div class="WhiteBadgeNum">3</div></span> <span class="badgeYellow-2"><div class="blackBadgeNum">3</div></span><span class="badgeRed-2"><div class="WhiteBadgeNum">3</div></span><span class="badgeOrange-2"><div class="WhiteBadgeNum">3</div></span> </div>
									<button id="buttonx-right" type="button" class="btn btn-info btn-block" ></button>									
	</div>							
								
						   	<br><br><br><br><br>
									<button id="buttonx-midlle" type="button" class="btn btn-info btn-block badge1"><span class="badgeGreen-6" style="top:-5%; right:98%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                <span class="badgeGreen-6" style="top:90%; right:-2%;  background-color: #4CAF50;"><div class="WhiteBadgeNum">3</div></span>
									                                                                                <span class="badgeYellow-6" style="top:85%; right:98%; color:black;  background-color: #ffff00;"><div class=" blackBadgeNum">3</div></span>
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-2%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													درآمد و حاشیه سود<br><img src="financial.png" alt="financial.png" height="38" width="38"><img src="balance.png" alt="balance.png" height="38" width="38"><img src="kpi.png" alt="kpi.png" height="38" width="38"></button>
								...
								<button id="buttonx-left" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:95%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
																													...
																													تجربه مشتری<br><img src="kpi.png" alt="kpi.png" height="38" width="38"><img src="experience.png" alt="experience.png" height="38" width="38"></button>
									...
									<button id="buttonx-right" type="button" class="btn btn-info btn-block badge1" ><span class="badgeGreen-6" style="top:-5%; right:90%;  background-color: #ff6600;"><div class="WhiteBadgeNum">3</div></span> 
									                                                                                ...
									                                                                                <span class="badgeGreen-6" style="top:-5%; right:-5%;  background-color: #f35958;"><div class="WhiteBadgeNum">3</div></span>
																													راندمان عملیاتی<br><img src="kpi.png" alt="kpi.png" height="38" width="38"><img src="efficiency.png" alt="efficiency.png" height="38" width="38"></button>
			<div class="hiddenn">						
