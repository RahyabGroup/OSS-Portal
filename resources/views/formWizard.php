				...
				<div id="content">
						...
						<div class="row">
								...
								<div class="col-lg-12" >
										...
										<label class="color" style="background-color:#edece5">Twitter Bootstrap Wizard Plugin</label>
														...
														<footer class="row">
															<div class="col-sm-4">
																	<section class="wizard">
																			<button type="button" class="btn btn-inverse previous"><i class="fa fa-angle-left"></i> Previous</button>
																			<button type="button" class="btn btn-theme next">Next <i class="fa fa-angle-right"></i></button>
																	</section>
															</div>
															<div class="col-sm-8 align-lg-right"><div class="wizard-status">Wizard step : <span></span></div></div>
														</footer>
												</div>
										</form>
										...
										<h1><strong>Wizard</strong>  [validate]</h1>
										<label class="color" style="background-color:#edece5"> Bootstrap Wizard </label>
												...
												<div class="tab-content">
														<div class="tab-pane fade" id="step1" parsley-validate parsley-bind> 
																...
																<div class="form-group">
																		...
																		<input type="password" class="form-control"  parsley-rangelength="[4,8]"  parsley-required="true" parsley-trigger="keyup" placeholder="4-8 Characters">
																</div>
														</div>
