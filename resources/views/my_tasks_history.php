...
<section style="position: absolute; padding:10px;" class="panel corner-flip">
				 ...
				 <h4 style="text-align:right;  font-size:15px; direction: rtl; font-family: BNAZANIN;">&emsp;تعداد<?php  echo $cc; ?>رکورد یافت شد </h4>
...
?>
	                                             ...
	                                             <footer class="panel-footer">
													 <div id="pagination_controls" align="right"> &emsp;&emsp;&emsp;&emsp;&emsp; </div>
