...
<div class="container">
<?php
include('my_task_params_my_group.php'); 
include('taskDetailes_my_group.php');
...
$record_per_page=5;
$total_records=$xx_my_group['count'];
...
for ($x =$start_from; $x <($start_from+$record_per_page); $x++) 
{
	...
	$l=$xx_my_group['data'][$x]['taskid'];
	$ll=$xx_my_group['data'][$x]['title'];
