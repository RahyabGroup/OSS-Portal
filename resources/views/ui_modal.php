...
<div id="wrapper">
				...
				<div id="content">
						...
						<div class="row">
								...
								<div class="col-lg-8">
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>UI</strong> Modals </h2>
														<label class="color">Bootstrap Modifly  with<strong><em>" bootstrap-modal "</em></strong> plugin </label>
												</header>
												<div class="panel-body">
														<table class="table table-striped">
																<thead>
																		<tr>
																				<th style="text-align:left">modals type</th>
																...
																<tbody>
																		<tr>
																				<td>Normal</td>
																				<td><button class="btn btn-theme btn-sm"  data-toggle="modal" data-target="#md-normal">See demo</button></td>
																		</tr>
																		<tr>
																				<td>Full-width</td>
																				<td><button class="btn btn-theme btn-sm" data-toggle="modal" data-target="#md-full-width">See demo</button></td>
																		</tr>
																		<tr>
																				<td>Custom width</td>
																				<td><button class="btn btn-theme btn-sm"  data-toggle="modal" data-target="#md-custom-width">See demo</button></td>
																		</tr>
																		<tr>
																				<td>Custom Header Color</td>
																				<td><button class="btn btn-theme btn-sm"  data-toggle="modal" data-target="#md-header-color">See demo</button></td>
																		</tr>
																		<tr>
																				<td>Stackable</td>
																				<td><button class="btn btn-theme btn-sm"  data-toggle="modal" data-target="#md-stack">See demo</button></td>
																		</tr>
																		<tr>
																				<td>AJAX (via jQuery.load)</td>
																				<td><button class="btn btn-theme btn-sm md-ajax-load">See demo</button></td>
																		</tr>
																		<tr>
																				<td>Long Modals</td>
																				<td><button class="btn btn-theme btn-sm"  data-toggle="modal" data-target="#md-long">See demo</button></td>
																		</tr>
																</tbody>
														</table>
												</div>
								...
								<div class="col-lg-4">
										...
										<section class="panel">
												<header class="panel-heading">
														<h2><strong>open</strong> Effect </h2>
														<label class="color">Bootstrap Modals effect </label>
												</header>
												<div class="panel-body">
														<table class="table table-striped">
																<thead>
																		<tr>
																				<th style="text-align:left">Effect Class</th>
																				<th style="text-align:left">Action</th>
																		</tr>
																</thead>
																<tbody>
																		<tr>
																				<td>.md-scale</td>
																				<td><button class="btn btn-theme btn-sm md-effect" data-effect="md-scale">Scale </button></td>
																		</tr>
																		<tr>
																				<td>.md-slideRight</td>
																				<td><button class="btn btn-inverse btn-sm md-effect" data-effect="md-slideRight">Slide Right </button></td>
																		</tr>
																		<tr>
																				<td>.md-slideUp</td>
																				<td><button class="btn btn-theme-inverse btn-sm md-effect" data-effect="md-slideUp">Slide Up  </button></td>
																		</tr>
																		<tr>
																				<td>.md-slideDown</td>
																				<td><button class="btn btn-warning btn-sm md-effect" data-effect="md-slideDown">Slide Down </button></td>
																		</tr>
																		<tr>
																				<td>.md-stickTop</td>
																				<td><button class="btn btn-danger btn-sm md-effect" data-effect="md-stickTop">Stick Top </button></td>
																		</tr>
																		<tr>
																				<td>.md-flipHor</td>
																				<td><button class="btn btn-primary btn-sm md-effect" data-effect="md-flipHor">Horizontal  Flip</button></td>
																		</tr>
																		<tr>
																				<td>.md-flipVer</td>
																				<td><button class="btn btn-success btn-sm md-effect" data-effect="md-flipVer">Vertical Flip</button></td>
																		</tr>
																</tbody>
														</table>
												</div>
		...
		/////////////////////////////////////////////////////////////////////////
		-->
		<div id="md-custom-width" class="modal fade" data-width="300" >
				<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
						<h4 class="modal-title">Modals custom width</h4>
				</div>
				<!-- //modal-header-->
				<div class="modal-body">
					<p>One fine body&hellip;</p>
		...
		/////////////////////////////////////////////////////////////////////////
		-->
		<div id="md-header-color" class="modal fade"  data-header-color="#736086">
				<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
		...
		<div id="md-stack2" class="modal fade" tabindex="-1" data-width="500" >
				...
				<div class="modal-footer">
						<button type="button" data-dismiss="modal" class="btn btn-inverse">Close</button>
						<button class="btn btn-theme" data-toggle="modal" data-target="#md-stack3">Launch modal</button>
				</div>
		</div>
		<div id="md-stack3" class="modal fade" tabindex="-1" data-width="400" >
				<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
						<h3>Stack Three</h3>
				</div>
		...
		/////////////////////////////////////////////////////////////////
		-->
		<div id="md-long" class="modal fade" tabindex="-1" data-replace="true">
				<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
