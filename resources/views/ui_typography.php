								...
								<div class="col-lg-8" >
										<section class="panel corner-flip">
												<header class="panel-heading">
														<h2><strong>UI</strong> Typography </h2>
												</header>
												...
												<div class="panel-body">
														<div class="divider">
																...
																<label class="color">default style <em><strong>h1 , h2 , h3 , h5 , h6</strong></em></label>
														</div>
														<hr>
														<div class="row">
																<div class="col-sm-6">
																...
																<!-- //col-sm-6 -->	
																<div class="col-sm-6">
																		<p><h1><strong>h1 Heading 1</strong></h1></p>
																		<p><h2><strong>h2 Heading 2</strong></h2></p>
																		<p><h3><strong>h3 Heading 3</strong></h3></p>
																		<p><h4><strong>h4 Heading 4</strong></h4></p>
																		<p><h5><strong>h5 Heading 5</strong></h5></p>
																		<p><h6><strong>h6 Heading 6</strong></h6></p>
																</div>
																<!-- //col-sm-6 -->	
														</div>
														<hr>
														<div class="divider">
																<h3><strong>List </strong> Style</h3>
																<label class="color">ul has class <em><strong>list-item  angle , arrow , circle ,check</strong></em></label>
														</div>
														
														<div class="row">
																<div class="col-md-3 col-sm-6">
																		<p><strong>List stlye angle</strong></p>
																...
																<div class="col-md-3 col-sm-6">
																	    <p><strong>List stlye arrow</strong></p>
																...
																<div class="col-md-3 col-sm-6">
																	    <p><strong>List stlye circle</strong></p>
																...
																<div class="col-md-3 col-sm-6">
																	    <p><strong>List stlye check</strong></p>
														...
														<hr>
														<div class="divider">
																<h3><strong>pre </strong> Code</h3>
																<label class="color">pre or code has class <em><strong>prettyprint lang-html , css , js , java ,  and Other</strong></em></label>
														</div>
														<div class="code">
														<h4>Html Code</h4>
...
Account = function(customer, cart) {
  ...
  return $('.shopping_cart').bind('click', function(event) {
    return _this.customer.purchase(_this.cart);
								...
								<div class="col-lg-4" >	
										<div class="divider">
												<h3><strong>Number List </strong> rounded</h3>
										</div>
										<ol class="rounded-list">
												<li><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque non leo convallis nibh tristique commodo.</a></li>
												<li><a href="#">Cras tincidunt hendrerit pharetra. Etiam erat magna, egestas sed placerat at</a></li>
										...
										<section class="panel corner-flip">
												<div class="panel-body">
														<div class="divider">
																<h3><strong>Number List </strong> rectangle</h3>
														</div>
										...
										<div class="well ">
												<h3><strong>Wells</strong> text </h3>
										...
										<div class="well bg-theme">
												<h3><strong>Wells</strong> Color </h3>
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque non leo convallis nibh tristique commodo.</p>
												<div class="flip"></div>
										</div>
										...
										<section class="panel corner-flip">
												<div class="panel-body">
														<div class="divider">
																<h3><strong>block</strong>quote </h3>
														</div>
														
														<blockquote>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque non leo convallis nibh tristique commodo.</p>
															<small>Zicedemo Include </small>
														</blockquote>
														<hr>
