						...
						<ul class="nav navbar-nav navbar-right tooltip-area">
								...
								<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
											<em><strong>Hi</strong>,  <?php echo Lang::get('language.personName')?>  </em> <i class="dropdown-icon fa fa-angle-down"></i>
										</a>
										<ul class="dropdown-menu pull-right icon-right arrow">
												...
												<li><a href="<?php echo url('lang/fa')?>"><i class="fa" value="fa"></i>فارسی &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;<img class="flag" src="fa.jpg" alt="Iran Flag" height="40" width="40"></label></a></li>
												...
												<li class="divider"></li>
												<li><a href="#"><i class="fa fa-sign-out"></i> <?php echo Lang::get('language.signout')?> </a></li>
										</ul>
										<!-- //dropdown-menu-->
								</li>
								<li class="visible-lg">
